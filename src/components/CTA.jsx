...
export default function CTA() {
  ...
  const badges = ["Réponse sous 24h", "Appel découverte offert", "Sans engagement"];
...
Discutons de ce qui vous pèse aujourd'hui — projets, coordination, décisions du quotidien. On regarde ensemble, sans engagement, si je suis le bon bras droit pour vous.            </p>
